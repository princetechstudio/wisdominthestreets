...
export const TIMELINE = [
  ...
  { year: "Next", title: "Live from Pokuase-Mayera", text: "The first open-street recording sessions: chairs in a circle, a mic in the middle, and the community asking the questions." },
];
...
/* ---------- Links & socials ---------- */
export const WHATSAPP_DISPLAY = "024 992 6969";
export const WHATSAPP_INTL = "233249926969";
export const CONTACT_EMAIL = "justmarbell@gmail.com";
...
export const HOST = {
  ...
  bio: [
    "Marvin Marbell grew up between a lorry station in Pokuase-Mayera and a classroom in Osu, and he never fully decided which one raised him — so he lets both speak. After six years in sales and one failed logistics startup, he started recording the wisdom he kept overhearing on street corners: traders negotiating like diplomats, drivers philosophising between fares, aunties dispensing financial advice sharper than any bank's.",
